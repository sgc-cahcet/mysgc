...
export function ForgotPasswordDialog() {
    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Trigger password reset email (Supabase sends OTP if configured)
    ...
    const handleVerifyAndReset = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. Update Password (user is now authenticated via verifyOtp)
                            ...
                            <div className="space-y-3 flex flex-col items-center">
                                ...
                                >
                                    <InputOTPGroup className="gap-2">
                                        <InputOTPSlot index={0} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                        <InputOTPSlot index={1} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                        <InputOTPSlot index={2} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                        <InputOTPSlot index={3} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                        <InputOTPSlot index={4} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                        <InputOTPSlot index={5} className="w-12 h-14 text-2xl font-black border-2 border-black rounded-lg bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]" />
                                    </InputOTPGroup>
                                </InputOTP>
                            </div>
